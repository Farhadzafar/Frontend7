...
// import { getBookByIdServer } from "@/lib/data/books.server";
...
export default async function BookDetailPage({ params }: Props) {
  ...
  const downloadUrl = book.fileLink
    ? `${process.env.NEXT_PUBLIC_API_ENDPOINT}${book.fileLink.replace(
        "/public",
        ""
      )}`
    : "";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="p-6 border">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="w-full md:w-48 lg:w-64 aspect-[3/4] rounded-lg overflow-hidden bg-gray-100 relative">
                  {coverUrl ? (
                    <Image
                      src={coverUrl}
                      alt={book.title}
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {book.fileSizeMB
                          ? `${Number(book.fileSizeMB).toFixed(2)} MB`
                          : "—"}
                      </p>
                    </div>
                  </div>
